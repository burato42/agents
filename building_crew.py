...
find_venue_task = Task(
    description=(
        "Conduct a thorough search to find the best venue for the upcoming conference in Amsterdam, Netherlands "
...
inputs = {
    ...
    "requirements": "Capacity for 1000, central location, modern amenities, budget up to 50,000 euro"
}
